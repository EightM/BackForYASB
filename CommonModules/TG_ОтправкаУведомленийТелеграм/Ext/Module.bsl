...
Процедура ОтправитьСообщения(РеквизитыЗадачи)
	...
	НастройкиПользователя = НастройкиСоставаПользователей(РеквизитыЗадачи.Исполнитель);
	Если НастройкиПользователя = Неопределено Тогда
		НастройкиПользователя = СформироватьСтандартныеНастройки();
	КонецЕсли; 
...
Функция НастройкиСоставаПользователей(Исполнитель)
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
...
Функция СформироватьСтандартныеНастройки()
